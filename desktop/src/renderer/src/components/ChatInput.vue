        ...
        <div class="flex items-center justify-between px-1 pt-1">
          <div class="flex items-center gap-1.5">
            ...
            <div class="relative">
              ...
              <div
                v-if="modelOpen"
                class="absolute bottom-10 left-0 z-10 min-w-52 rounded-xl border border-stone-200 bg-white py-1 shadow-lg"
              >
                <button
                  v-for="m in models"
                  :key="m.value"
                ...
                <div class="border-t border-stone-100 px-2 py-2">
                  <input
                    ...
                    type="text"
                    placeholder="自定义模型名…"
                    class="w-full rounded-md border border-stone-200 px-2 py-1.5 text-xs outline-none focus:border-stone-400"
