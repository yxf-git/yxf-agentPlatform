...
import { ref } from "vue"
import { PenSquare, MessageSquare, Trash2, Settings } from "lucide-vue-next"
  ...
  <aside class="flex h-full w-[260px] flex-col bg-[#f9f9f9]">
    <div class="flex items-center justify-between px-3 py-3">
      <div class="flex items-center gap-2 px-1">
        ...
        <span class="text-sm font-semibold text-stone-800">小飞侠</span>
      </div>
    </div>
    ...
    <div class="border-t border-stone-200/70 px-2 py-2">
      <button
        class="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-2 text-sm text-stone-600 transition-colors hover:bg-stone-200/50"
